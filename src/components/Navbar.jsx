...
export default function Navbar() {
  return (
    <>
      <div>
        <nav className="fixed z-[999] w-full px-5 sm:px-10 md:px-20 py-4 sm:py-6 md:py-8 flex flex-row justify-between items-center bg-white/20 backdrop-blur-md">
          <div className="w-[50%]">
            <svg
              width="50"
              height="25"
          ...
          <div className="flex gap-6 sm:gap-8 md:gap-10 cursor-pointer">
            {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
              (item, index) => (
                <a
                  key={index}
                  className={`text-[3vw] sm:text-[2vw] md:text-[1vw] font-light ${
                    index === 4 && "ml-12 sm:ml-20 md:ml-32"
                  }`}
                >
                  {item}
                </a>
