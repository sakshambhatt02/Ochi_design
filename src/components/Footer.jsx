...
export default function Footer() {
  return (
    <>
      <div className="w-full h-screen  p-8 sm:p-16 md:p-20 flex flex-col lg:flex-row gap-8 lg:gap-5">
        <div className="w-full lg:w-1/2 h-full flex flex-col justify-between">
          <div>
            <h1 className="text-[10vw] sm:text-[7vw] md:text-[6vw] uppercase leading-none font-semibold">
              Eye-
            </h1>
            <h1 className="text-[10vw] sm:text-[7vw] md:text-[6vw] uppercase leading-none font-semibold">
              Opening
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[8vw] sm:text-[6vw] md:text-[5vw] uppercase leading-none font-semibold">
            Presentations
          </h1>
          <div className="mt-6 sm:mt-10 flex flex-col space-y-4">
